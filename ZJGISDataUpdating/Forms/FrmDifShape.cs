...
{
    public partial class FrmDifShape : DevComponents.DotNetBar.Office2007Form
    {
        Form previousForm;
        ...
        private void buttonXStartMatch_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridViewX2.RowCount; i++)
            {
                ...
                {
                    //第一列名称和第二列名称是否相等
                    string test1 = this.dataGridViewX2[1, i].Value.ToString();
                    string test2 = this.dataGridViewX2[2, i].Value.ToString();
                    ...
                    else
                    {
                        ...
                        tempFieldsName = tempFieldsName + dataGridViewX2[1, i].Value.ToString() + "_" + dataGridViewX2[2, i].Value.ToString();
                    }
                }
        ...
        /// <param name="pSourceFeatCls">源图层</param>
        private void loadFeatSetting(string m_WorkspacePath, string m_MatchedFCName, IFeatureClass pSourceFeatCls)
        {
            if ((m_MatchedFCName != "") && (ClsDeclare.g_WorkspacePath != ""))
            {
                ...
                if (this.tabControl1.Tabs[0].Visible)
                {
                    ...
                    if (!pDic.ContainsKey(m_MatchedFCName))
                    {
                        ...
                        IDataset dataset = pSourceFeatCls as IDataset;
