...
{
    /// <summary>
    /// Summary description for clsSelectByRectangle.
    /// </summary>
    [Guid("bfd3f238-dec7-4d0b-85b2-8bf1457da9fe")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("SelectQuery.clsSelectByRectangle")]
    public sealed class ClsSelectByRectangle : BaseTool
    {
        ...
        public ClsSelectByRectangle()
        {
            //
            
            //
            base.m_category = "SelectQuery"; //localizable text 
            base.m_caption = "面选择";  //localizable text 
            base.m_message = "拉框选择要素";   //localizable text 
            base.m_toolTip = "面选择";  //localizable text
            base.m_name = "A1040001E";   //unique id, non-localizable (e.g. "MyCategory_MyTool")
            try
            {
                //
                ...
                //base.m_bitmap = new Bitmap(GetType(), "Resources.矩形选择.bmp");
                //ResourceManager resource = new ResourceManager("SelectQuery.Resources", Assembly.GetExecutingAssembly());
                //base.m_bitmap = (Bitmap)resource.GetObject("矩形选择");
                ResourceManager rm = new ResourceManager("ZJGISSelectQuery.Properties.Resources", Assembly.GetExecutingAssembly());
                //base.m_bitmap = (Bitmap)rm.GetObject("矩形选择");
                //base.m_cursor = new System.Windows.Forms.Cursor(GetType(), "Resources.SelectFeatures.cur");
            }
            catch (Exception ex)
            {
