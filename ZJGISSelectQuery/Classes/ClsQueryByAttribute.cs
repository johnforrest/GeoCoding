...
namespace SelectQuery 
{
    ...
    public sealed class ClsQueryByAttribute : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            try
            {
                if (m_frmQueryByAttribute == null)
                    m_frmQueryByAttribute = new FrmQueryByAttribute();
                else
                {
                    if (m_frmQueryByAttribute.IsDisposed)
                        m_frmQueryByAttribute = new FrmQueryByAttribute();
                }
                m_frmQueryByAttribute.Show();
            }
            catch (Exception)
            {
            }
